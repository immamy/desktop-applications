...
| `comboBox_Permissions選項` | read from `Setting.txt` |
| `comboBox_Permissions_1選項` | read from `Setting.txt` |
| `comboBox_Permissions_2選項` | read from `Setting.txt` |
| `comboBox_Permissions_3選項` | read from `Setting.txt` |
| `comboBox_Permissions_4選項` | read from `Setting.txt` |
| `comboBox_Department_1選項` | read from `Deosit.txt` |
| `comboBox_Department_2選項` | read from `Deosit.txt` |
| `comboBox_Department_3選項` | read from `Deosit.txt` |
| `comboBox_Department_4選項` | read from `Deosit.txt` |
| `comboBox_Name_1選項` | read from `Deosit.txt` |
| `comboBox_Name_2選項` | read from `Deosit.txt` |
| `comboBox_Name_3選項` | read from `Deosit.txt` |
| `comboBox_Name_4選項` | read from `Deosit.txt` |
